const MainRoutes = {
    ...
    children: [
        {
            path: '/',
            redirect: "/dashboards/general",
        },
        {
            name: 'General',
            path: '/dashboards/general',
            component: () => import('@/views/dashboards/general/index.vue'),
        },
        {
            name: 'Classic',
        ...
        },
        {
            ...
            component: () => import('@/views/dashboards/analytical/index.vue'),
        },
        {
            name: 'Minimal',
            path: '/dashboards/campaign',
            component: () => import('@/views/dashboards/campaign/index.vue'),
        },
        {
            name: 'Ecommerce',
