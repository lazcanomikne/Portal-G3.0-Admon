...
const chartOptions = computed(() => {
    return {
        ...
        colors: ['rgba(var(--v-theme-grey100))', 'rgba(var(--v-theme-grey100))', 'rgba(var(--v-theme-primary))', 'rgba(var(--v-theme-grey100))', 'rgba(var(--v-theme-grey100))', 'rgba(var(--v-theme-grey100))'],
        plotOptions: {
            bar: {
                borderRadius: 4,
                columnWidth: '45%',
